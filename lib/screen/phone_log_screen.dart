...
class _PhonelogsScreenState extends State<PhonelogsScreen> with  WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Scaffold(
        appBar: AppBar(centerTitle: true,title: Text('전화 기록'),toolbarHeight: 60,backgroundColor: Colors.black26, ),
        body: Column(
          children: [
            ...
            FutureBuilder<Iterable<CallLogEntry>>(future: logs,builder: (context, snapshot){
